  ...
  return (
    <section id="portfolio-gallery" className="py-20 lg:py-32 bg-background">
      <div className="container mx-auto px-4 lg:px-8">
        ...
        <div className="relative bg-red-500/5 backdrop-blur-sm rounded-2xl p-8 lg:p-12 border border-primary-foreground/10 text-center flex flex-col items-center justify-center min-h-[300px]">
          ...
          <p className="text-xl font-semibold mb-2 text-red-500">Unable to load portfolio gallery</p>
          <p className="text-red-500/70 mb-6 max-w-md mx-auto">We couldn't retrieve the portfolio gallery at this moment. Please check your connection or try refreshing the page.</p>
          <button 
            onClick={() =>refetch()} 
            className="px-6 py-2 bg-red-500/10 hover:bg-red-500/20 text-red-500 rounded-full transition-colors border border-red-500/20"
          >
            Try Again
          </button>
        </div>
